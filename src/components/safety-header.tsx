...
export default function SafetyHeader() {
  return (
    <header className="bg-slate-900 border-b border-slate-800/90 sticky top-0 z-50">
      <div className="max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8 h-13 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          <div className="flex items-center gap-1.5 bg-slate-950 border border-slate-800 px-2.5 py-1 rounded-sm text-xs font-mono">
            <span className="h-1.5 w-1.5 rounded-full bg-emerald-500"></span>
            <span className="text-slate-400">Safety Engine:</span>
            <span className="text-emerald-400 font-medium">ACTIVE</span>
          </div>

          <div className="flex items-center bg-slate-950 border border-slate-800 px-2.5 py-1 rounded-sm text-xs font-mono text-slate-400">
